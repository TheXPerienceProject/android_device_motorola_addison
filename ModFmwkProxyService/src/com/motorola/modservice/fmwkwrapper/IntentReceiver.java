        ...
        if ("com.motorola.modservice.BATTERY_MODE".equals(action)) {
            ...
            if ("com.motorola.mod.action.SERVICE_STARTED".equals(action)) {
                ...
                if (intent.getIntExtra("powerMode", -1) == 1) {
                    ...
                    new Thread(new Runnable() {
                        public void run() {
                            IntentReceiver.acquireWakeLockThread(context2, 32768);
                        }
                    }).start();
                }
            ...
            } else if ("com.motorola.mod.action.SET_ROTATION".equals(action)) {
                ...
                try {
                    ...
                    Log.w("fwkintentreceiver", "Unable to set auto-rotate setting");
                }
            }
        }
    }
